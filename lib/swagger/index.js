...
module.exports = options => {
  ...
  rootWritePath[`${opts.pathPrefix.write}/${entityPath}`] = {
    post: {
      ...
      responses: Object.assign({}, entityResponse, opts.getErrorResponses({ exclude: '404' }))
    },
    put: {
      tags: [opts.tag.write.name || entityName],
      ...
      responses: Object.assign({}, entityResponse, opts.getErrorResponses())
    }
  };
  ...
  const idParameters = [{ $ref: `#/definitions/${entityName}-id-parameter` }];
  ...
  definitions[`${entityName}-updating`] = Object.assign({}, opts.entity.schema);
  ...
  definitions[`${entityName}-id-parameter`] = {
