...
module.exports = options => {
  ...
  function getQueryParameters(config) {
    const params = getBodyParameters(config);
    params[0].in = 'query';
    return params;   
  }
  ...
  function getSearchControlsQueryParameters() {
    ...
    return getQueryParameters({
      ...
      description: `Search controls for finding ${entityName}`,
      entityName: definitionNames.searchControls,
    });
  }
